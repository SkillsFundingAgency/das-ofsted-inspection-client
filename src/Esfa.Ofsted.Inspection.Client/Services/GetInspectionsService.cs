...
namespace Esfa.Ofsted.Inspection.Client.Services
{
    public class GetInspectionsService : IGetInspectionsService
    {
        ...
        public GetInspectionsService(IProcessExcelFormulaToLink processExcelFormulaToLink, IOverallEffectivenessProcessor overallEffectivenessProcessor)
        {
        ...
        public InspectionsDetail GetInspectionsDetail(string firstLinkUrl)
        {
            ...
            using (var client = new WebClient())
            {
                    ...
                    new MemoryStream(client.DownloadData(new Uri(firstLinkUrl))))
                {
                    ...
                    {
                        inspectionsDetail = GetOsftedInspections(package);
                    }
                }
            }
        ...
        private InspectionsDetail GetOsftedInspections(ExcelPackage package)
        {
